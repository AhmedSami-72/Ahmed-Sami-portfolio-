...
const translations = {
    en: {
        ...
        proj_lawyers_desc: "A professional website for a law firm to display legal services and consultations in an organized and professional manner. The site presents legal services, the firm's experience, and contact methods with a design suitable for law offices. The project was implemented using a ready-made platform and supports both Arabic and English.",
        proj_marasem_desc: "An introductory website for Al Marasem Al Gharbia Projects, a company operating in the contracting and construction field within Saudi Arabia. The site showcases the company's services, engineering solutions, and completed projects with a professional corporate design.",
        proj_fanniman_desc: "A website for Fanniman, a Saudi establishment specializing in home and building maintenance services. The site connects customers with specialized technicians for services like electrical, plumbing, and general maintenance for homes and buildings. The site supports both Arabic and English.",
        proj_email_generator_desc: "A web tool built with Front-End technologies that automatically generates multiple different emails from a single email. The tool helps users create various email formats quickly and easily, with the ability to manage and copy the resulting emails through a simple and user-friendly interface.",
        proj_tourism_system_desc: "An integrated management system designed for tourism companies to efficiently organize and manage daily operations. The system allows for the organized management of tours, bookings, and customer data, helping tourism companies track their services and manage reservations through a modern, user-friendly interface.",
    ...
    ar: {
        ...
        proj_lawyers_desc: "موقع احترافي خاص بمكتب محاماة لعرض الخدمات والاستشارات القانونية بطريقة منظمة واحترافية. يعرض الموقع الخدمات القانونية وخبرة المكتب وطرق التواصل مع العملاء بتصميم مناسب للمكاتب القانونية. تم تنفيذ المشروع باستخدام منصة جاهزة ويدعم اللغتين العربية والإنجليزية.",
        proj_marasem_desc: "موقع تعريفي لشركة المراسم الغربية للمشاريع، وهي شركة تعمل في مجال المقاولات والإنشاءات داخل المملكة العربية السعودية. يعرض الموقع خدمات الشركة والحلول الهندسية التي تقدمها بالإضافة إلى المشاريع التي تقوم بتنفيذها، مع تصميم احترافي مناسب للشركات.",
        proj_fanniman_desc: "موقع خاص بمؤسسة فني مان لصيانة المباني، وهي مؤسسة سعودية متخصصة في خدمات الصيانة المنزلية وصيانة المباني. يتيح الموقع ربط العملاء بفنيين متخصصين لتقديم خدمات مثل صيانة الكهرباء والسباكة وأعمال الصيانة العامة للمنازل والمباني. الموقع يدعم اللغتين العربية والإنجليزية.",
        proj_email_generator_desc: "أداة ويب مبنية بتقنيات الـ Front-End تقوم بتوليد عدة إيميلات مختلفة بشكل تلقائي انطلاقًا من إيميل واحد. تساعد الأداة المستخدمين على إنشاء عدة صيغ للإيميلات بسرعة وسهولة، مع إمكانية إدارة الإيميلات الناتجة ونسخها بسهولة من خلال واجهة بسيطة وسهلة الاستخدام.",
        proj_tourism_system_desc: "نظام إدارة متكامل مصمم لشركات السياحة لتنظيم وإدارة العمليات اليومية بشكل فعال. يتيح النظام إدارة الرحلات السياحية والحجوزات وبيانات العملاء بطريقة منظمة، ويساعد شركات السياحة على متابعة خدماتها وإدارة الحجوزات من خلال واجهة حديثة وسهلة الاستخدام.",
